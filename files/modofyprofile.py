...
<body style="background-image: url(img/pp.jpg); background-repeat: no-repeat;background-size: 100% 100%;">
	<ul style=" list-style-type: none;margin-top: 1px; padding: 0;overflow: hidden; background-color: hsl(0, 54%, 47%);">
      <li style="float: right;"><a class="active" href="#home" style="display: block;color: white;text-align: center;padding: 14px 16px;text-decoration: none;"><i class="fas fa-home"></i>  Back To Profile</a></li>
  </ul>
  <div class="booking-form-w3layouts">
		...
		<!-- Form starts here -->''')
src="SELECT * FROM registration WHERE pid=1"
...
if rs:
    ...
    for rec in rs:
        print('''<div class="field-agileinfo-spc form-w3-agile-text">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="fname" value={} placeholder="Father Name" required="">
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="mname" value={} placeholder="Mother Name" required="">
				</div>
			</div>
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					...
					<div class="field-agileinfo-spc form-w3-agile-text2">
						<input id="datepicker1" name="dob" value={} type="date"  required="">
				    </div>		
			</div>
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="mob" value={} placeholder="Mobile Number" required maxlength="10">
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="age" value={} placeholder="Age" required="">
				</div>'''.format(rec[1],rec[2],rec[3],rec[4],rec[5],rec[6],rec[7]))
print('''
			</div>
...
print('''>
			...
			<div class="field-agileinfo-spc form-w3-agile-text1">
				<select class="form-control" name="bld">
									<option value="{}">{}</option>'''.format(rec[9],rec[9]))
...
print('''    
			...
			<div class="field-agileinfo-spc form-w3-agile-text2">
				<select class="form-control" name="city">
									<option value="{}">{}</option>'''.format(rec[10],rec[10]))
city = ["Kolkata", "Siliguri", "Medinipur", "Bakura", "Nodia", "Darjeeling", "Bardwan", "Kharagpur", "Haldia",
        "Asansol", "Durgapur"]
for i in city:
    print('<option value="{}">{}</option>'.format(i, i))
print('''
		...
		<div class="main-flex-w3ls-sectns">
			<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" value={} name="wght" placeholder="Weight (Kg)" required="">
			</div>
			<div class="field-agileinfo-spc form-w3-agile-text2">

				<input type="text" value={} name="hght" placeholder="Height (Feet/Centimeters)" required="">
		    </div>
		</div>
		<div class="main-flex-w3ls-sectns">
		<div class="textbox" >          
			<input type="Password" value={} id="psw" placeholder="Password" name="psw" required maxlength="30">
		</div>
		<div class="textbox">          
			<input type="Password" value={} id="pssw" placeholder="Confirm Password" name="re-password" required maxlength="30" >
			<span id="msg" style="color: red;"></span>

		</div>'''.format(rec[11],rec[12],rec[13],rec[14],rec[14]))
print('''
	</div>
		<div class="main-flex-w3ls-sectns">
			<div class="field-agileinfo-spc form-w3-agile-text1">
				<select class="form-control" name="sques" required>
									<option value="{}">{}</option>'''.format(rec[15],rec[15]))
...
print('''							</select>
			...
			<div class="field-agileinfo-spc form-w3-agile-text2">
				<div class="field-agileinfo-spc form-w3-agile-text2">
					<input type="text" name="sans" placeholder="Security Answer" required="">'''.format(rec[16]))
print('''
				</div>
			</div>
			</div>
...
if frm.getvalue('ok'):
    ...
    try:
        ...
        if rec:
            print(
                '''<h1 style="font-family: loud; font-size: 50px; text-align: center; color: red">You are already registered</h1>''')
        else:
            sql = "INSERT INTO registration(name,fname,mname,email,dob,mob,age,gen,blood,city,addr,wgh,hgh,psw,squs,sans) VALUES ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(
                name, fname, mname, email, dob, mob, age, gen, bld, city, addr, wght, hght, psw, sques, sans)
            cursor.execute(sql)
            config.db8.commit()
            config.db8.close()
            print(
                '''<h1 style="font-family: loud; font-size: 50px; text-align: center; color: rgb(62, 192, 68);">Registration Successfull</h1>''')
