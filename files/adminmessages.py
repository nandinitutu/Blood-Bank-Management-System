                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="hero-widget well well-sm">
                                <img src="img//msg.jpg" width="1400px" height="550px"> 
                            </div>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h1 id="request" class="page-header" style="color: rgb(180, 0, 0); border-bottom-color: rgb(151, 0, 0);">All Messages...........</h1>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
    ...
    print('''                                  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center; color: rgb(209, 0, 52);">Messges</th>                                                            
                                                        </tr>
                                                    </thead>
                                                    <tbody>''')
    for rec in rs:
        print('''<tr>
            ...
            <td>{}</td>
            <td>{}</td>            
            </tr>'''.format(rec[1], rec[2], rec[3], rec[4]))
    print('''                                       </tbody>
                                                </table>
                                            </div>
                                        </div>
